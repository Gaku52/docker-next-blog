  ...
  return (
    <Link href={`/posts/${slug}`}>
      <a className="justify-center select-none overflow-hidden w-full h-full vstack sm:flex-row cursor-pointer p-2 focus:outline- ">
        <div className="m-auto center w-full sm:w-1/3 h-48 sm:h-full bg-neutral-50 sm:bg-transparent">
          <Image
            src={coverImage}
            alt={`Cover Image for ${title}`}
            className="border-2 w-auto h-full object-cover sm:w-auto sm:h-40"
          />
        </div>
